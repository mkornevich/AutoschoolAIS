...
namespace AutoschoolAIS.Components.Student
{
    public partial class StudentListForm : Form
    {
        ...
        private void ReloadTable()
        {
            ...
            studentsTV.DataSource = dataSet.Tables[0];
        }
        ...
        {
            var row = ((DataRowView)studentsTV.SelectedRows[0].DataBoundItem).Row;
        ...
        {
            var row = ((DataRowView)studentsTV.SelectedRows[0].DataBoundItem).Row;
            var command = Env.Database.CreateCommand("DELETE FROM [Student] WHERE Id = @Id");
