...
namespace AutoschoolAIS.Components.Main
{
    partial class AboutForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label4.Text = "Данная программа позволяет на базовом\r\nуровне регистрировать различные события\r\nи" +
    " объекты для автошкол и после строить по\r\nэтим данным различные отчеты.";
            // 
            // AboutForm
            // 
